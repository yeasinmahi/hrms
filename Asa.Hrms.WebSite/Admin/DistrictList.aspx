<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="DistrictList.aspx.cs" Inherits="GITS.Hrms.WebSite.Admin.DistrictList" Title="" %>
			...
			<td>
				<asp:GridView ID="gvList" runat="server" OnRowCreated="gvList_RowCreated" OnSorting="gvList_Sorting" DataKeyNames="Id">
					<Columns>
						...
						<asp:HyperLinkField DataTextField="Name" HeaderText="Name" SortExpression="Name" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="DistrictAdd.aspx?Id={0}"></asp:HyperLinkField>
					</Columns>
				</asp:GridView>
			</td>
		</tr>
