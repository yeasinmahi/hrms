<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="ExamNameList.aspx.cs" Inherits="GITS.Hrms.WebSite.Admin.ExamNameList" Title="" %>
			...
			<td>
				<asp:GridView ID="gvList" runat="server" OnRowCreated="gvList_RowCreated" OnSorting="gvList_Sorting" DataKeyNames="Id">
					<Columns>
						...
						<asp:HyperLinkField HeaderText="Name" DataTextField="Name" SortExpression="Name" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="ExamNameAdd.aspx?Id={0}"></asp:HyperLinkField>
					</Columns>
				</asp:GridView>
			</td>
		</tr>
