<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="H_IndividualReport.aspx.cs" Inherits="GITS.Hrms.WebSite.Reports.H_IndividualReport" Title="Untitled Page" %>
...
<asp:Panel ID="pnlSerach" runat="server" DefaultButton="lbSearch">
    <table >
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:TextBox ID="txtZone" runat="server" Enabled="False" 
                    ForeColor="ActiveCaptionText" ReadOnly="True" Width="200px"></asp:TextBox>
            </td>
            <td>
                ASA District</td>
            <td style="width: 126px">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:TextBox ID="txtRegion" runat="server" Enabled="False" 
                    ForeColor="ActiveCaptionText" ReadOnly="True" Width="200px"></asp:TextBox>
            </td>
            <td>
                Branch</td>
 ...
 <asp:Panel ID="pnlTras" runat="server" GroupingText="Transfer Information">
     <asp:GridView ID="gvTransfer" Width="100%" runat="server" SkinID="Report">
     </asp:GridView>
 </asp:Panel>
 <asp:Panel ID="pnlLeave" runat="server" GroupingText="Leave Information">
 ...
 <asp:Panel ID="Panel2" runat="server" GroupingText="Promotion/Demotion Information">
