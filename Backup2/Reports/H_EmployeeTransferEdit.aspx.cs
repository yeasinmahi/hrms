    ...
    public partial class H_EmployeeTransferEdit : AddPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                User user = Asa.Hrms.Data.Entity.User.GetByLogin(User.Identity.Name);
                if (user.UserType == Asa.Hrms.Data.Entity.User.UserTypes.Field_User)
                {
        ...
        {
            var aTransactionManager = new Asa.Hrms.Data.TransactionManager(false);
        ...
        protected void gvConsultancy_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            if (ddlOrganization != null && ddlCountry != null)
            {
                ...
                ddlCountry.DataSource = Asa.Hrms.Data.Entity.Country.Find("", "Name");
                ddlCountry.DataBind();
                ddlCountry.SelectedValue = consuntancy.CountryId.ToString();


                ddlOrganization.DataSource = Asa.Hrms.Data.Entity.Organization.Find("", "Name");
