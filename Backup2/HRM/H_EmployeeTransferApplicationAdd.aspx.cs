...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeTransferApplicationAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeTransferApplication GetH_EmployeeTransferApplication()
        {
        ...
        protected override Message Save()
        {
            ...
            {
                string desc = null;
                Asa.Hrms.Data.Entity.H_EmployeeTransferApplication hEmployeeTransferApplication = this.GetH_EmployeeTransferApplication();
                if (this.Type == TYPE_EDIT)
                {
                ...
                if (this.Type == TYPE_EDIT)
                {
                    Asa.Hrms.Data.Entity.H_EmployeeTransferApplication.Update(this.TransactionManager, hEmployeeTransferApplication);
                }
                else
                {
                    ...
                    Asa.Hrms.Data.Entity.H_EmployeeTransferApplication.Insert(this.TransactionManager, hEmployeeTransferApplication);
        ...
        protected override void LoadData()
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                H_EmployeeTransferApplication hEmployeeTransferApplication = Asa.Hrms.Data.Entity.H_EmployeeTransferApplication.GetById(Convert.ToInt32(hdnId.Value));
