...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeDropAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeDropHistory GetH_EmployeeDrop()
        {
            Asa.Hrms.Data.Entity.H_EmployeeDropHistory h_EmployeeDrop = null;
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                if (h_Employee != null)
                {
                    Asa.Hrms.Data.Entity.H_EmployeeDropHistory h_EmployeeDrop = this.GetH_EmployeeDrop();
                    ...
                    if (this.Type == TYPE_ADD)
                    {
                        ...
                        Asa.Hrms.Data.Entity.H_EmployeeDropHistory.Insert(this.TransactionManager, h_EmployeeDrop);
                    }
                    else
                    {
                        Asa.Hrms.Data.Entity.H_EmployeeDropHistory.Update(this.TransactionManager, h_EmployeeDrop);
                    }
        ...
        protected override void LoadData()
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                H_EmployeeDropHistory h_EmployeeDropHistory = Asa.Hrms.Data.Entity.H_EmployeeDropHistory.GetById(Convert.ToInt32(hdnId.Value));
