    ...
    public partial class H_SpecialIncrementAdd : AddPage
    {
        ...
        protected override Asa.Hrms.Utility.Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                Asa.Hrms.Data.Entity.H_SpecialIncrement h_EmployeePenalty = this.GetH_SpecialIncrement();
                ...
                if (this.Type == TYPE_EDIT)
                {
                    Asa.Hrms.Data.Entity.H_SpecialIncrement.Update(this.TransactionManager, h_EmployeePenalty);
                }
                else
                {
                    Asa.Hrms.Data.Entity.H_SpecialIncrement.Insert(this.TransactionManager, h_EmployeePenalty);
                }
        ...
        private Asa.Hrms.Data.Entity.H_SpecialIncrement GetH_SpecialIncrement()
        {
            Asa.Hrms.Data.Entity.H_SpecialIncrement h_EmployeePenalty = null;
            if (this.Type == TYPE_EDIT)
            {
