...
public partial class H_EmployeeList : GridPage
{
	...
	protected override void OnInit(EventArgs e)
	{
		...
		this.BaseEntityType = typeof(Asa.Hrms.Data.Entity.H_Employee);
        this.EntityType = typeof(Asa.Hrms.Data.View.H_EmployeeView);
	}
    ...
    protected override Asa.Hrms.Utility.Message Delete(TransactionManager transactionManager, int id)
    {
        Asa.Hrms.Utility.Message msg = new Asa.Hrms.Utility.Message();
