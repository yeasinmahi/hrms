...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeIncrementHeldupRemissionAdd : AddPage
    {
        ...
        {
            Asa.Hrms.Data.Entity.H_EmployeeIncrementHeldup h_EmployeeIncrementHeldup = null;
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                Asa.Hrms.Data.Entity.H_EmployeeIncrementHeldup.Update(this.TransactionManager, h_EmployeeIncrementHeldup);
