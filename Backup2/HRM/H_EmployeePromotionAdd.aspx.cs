...
public partial class H_EmployeePromotionAdd : AddPage
{
    ...
    private Asa.Hrms.Data.Entity.H_EmployeePromotionHistory GetH_EmployeePromotion()
	{
        Asa.Hrms.Data.Entity.H_EmployeePromotionHistory h_EmployeePromotion = null;
	...
	protected override Message Save()
	{
        ...
        {
            string desc = "";
            Asa.Hrms.Data.Entity.H_EmployeePromotionHistory h_EmployeePromotion = this.GetH_EmployeePromotion();
            if (this.Type == TYPE_EDIT)
            {
            ...
            if (this.Type == TYPE_EDIT)
            {
                Asa.Hrms.Data.Entity.H_EmployeePromotionHistory.Update(this.TransactionManager, h_EmployeePromotion);
            }
            else
            {
                Asa.Hrms.Data.Entity.H_EmployeePromotionHistory.Insert(this.TransactionManager, h_EmployeePromotion);
            }
	...
	protected override void LoadData()
	{
        ...
        if (Request.QueryString["Id"] != null)
        {
            ...
            H_EmployeePromotionHistory h_History = Asa.Hrms.Data.Entity.H_EmployeePromotionHistory.GetById(Convert.ToInt32(hdnId.Value));
            if (h_History != null)
            {
