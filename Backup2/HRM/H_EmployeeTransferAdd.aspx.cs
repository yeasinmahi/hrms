...
public partial class H_EmployeeTransferAdd : AddPage
{
    ...
    private Asa.Hrms.Data.Entity.H_EmployeeTransferHistory GetH_EmployeeTransfer()
    {
    ...
    protected override Message Save()
    {
        ...
        {
            string desc = null;
            Asa.Hrms.Data.Entity.H_EmployeeTransferHistory h_EmployeeTransfer = this.GetH_EmployeeTransfer();
            if (this.Type == TYPE_EDIT)
            {
            ...
            if (this.Type == TYPE_EDIT)
            {
                Asa.Hrms.Data.Entity.H_EmployeeTransferHistory.Update(this.TransactionManager, h_EmployeeTransfer);
            }
            else
            {
                Asa.Hrms.Data.Entity.H_EmployeeTransferHistory.Insert(this.TransactionManager, h_EmployeeTransfer);
            }
    ...
    protected override void LoadData()
    {
        ...
        if (Request.QueryString["Id"] != null)
        {
            ...
            H_EmployeeTransferHistory h_History = Asa.Hrms.Data.Entity.H_EmployeeTransferHistory.GetById(Convert.ToInt32(hdnId.Value));
