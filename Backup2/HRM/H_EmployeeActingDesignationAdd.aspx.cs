...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeActingDesignationAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeActingDesignation GetH_EmployeeActingDesignation()
        {
            Asa.Hrms.Data.Entity.H_EmployeeActingDesignation h_EmployeeActingDesignation = new H_EmployeeActingDesignation();
        ...
        protected override Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.H_EmployeeActingDesignation h_EmployeeActingDesignation = this.GetH_EmployeeActingDesignation();
                string desc = "Insert [H_EmployeeActingDesignation]";

                this.TransactionManager = new TransactionManager(true, desc);

                Asa.Hrms.Data.Entity.H_EmployeeActingDesignation.Insert(this.TransactionManager, h_EmployeeActingDesignation);
