...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeConsultencyAdd : AddPage
    {
        ...
        protected override Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.H_EmployeeConsultency h_Consultency = this.GetH_EmployeeConsultency();
                string desc = "";
                ...
                if (this.Type == TYPE_ADD)
                {
                    Asa.Hrms.Data.Entity.H_EmployeeConsultency.Insert(this.TransactionManager,h_Consultency);
                ...
                {
                    Asa.Hrms.Data.Entity.H_EmployeeConsultency.Update(this.TransactionManager,h_Consultency);
                }
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeConsultency GetH_EmployeeConsultency()
        {
            //TransactionManager tm = new TransactionManager(false);
            
            Asa.Hrms.Data.Entity.H_EmployeeConsultency h_Consultency = null;

            if (this.Type == TYPE_EDIT)
            {
               IList<H_EmployeeConsultency> list = Asa.Hrms.Data.Entity.H_EmployeeConsultency.Find("H_EmployeeId="+Convert.ToInt32(hdnId.Value)+" AND Status=1","");
               h_Consultency = list[0];

            }
            else
            {
                h_Consultency = new Asa.Hrms.Data.Entity.H_EmployeeConsultency();
        ...
        {
            this.ddlCountry.DataSource = Asa.Hrms.Data.Entity.Country.Find("", "Name");
            this.ddlCountry.DataBind();
            this.ddlCountry.Items.Insert(0, new ListItem("Select Country","0"));
            
            this.ddlNgo.DataSource = Asa.Hrms.Data.Entity.Organization.Find("", "Name");
