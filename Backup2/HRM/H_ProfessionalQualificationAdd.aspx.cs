...
public partial class H_ProfessionalQualificationAdd : AddPage
{
	...
	private Asa.Hrms.Data.Entity.H_ProfessionalQualification GetH_ProfessionalQualification()
	{
		Asa.Hrms.Data.Entity.H_ProfessionalQualification h_ProfessionalQualification = null;

		if (this.Type == TYPE_EDIT)
		{
			h_ProfessionalQualification = Asa.Hrms.Data.Entity.H_ProfessionalQualification.GetById(Convert.ToInt32(hdnId.Value));
		}
		else
		{
			h_ProfessionalQualification = new Asa.Hrms.Data.Entity.H_ProfessionalQualification();
	...
	protected override Message Save()
	{
		...
		{
			Asa.Hrms.Data.Entity.H_ProfessionalQualification h_ProfessionalQualification = this.GetH_ProfessionalQualification();
			string desc = "";
			...
			if (this.Type == TYPE_ADD)
			{
				Asa.Hrms.Data.Entity.H_ProfessionalQualification.Insert(this.TransactionManager, h_ProfessionalQualification);
			...
			{
				Asa.Hrms.Data.Entity.H_ProfessionalQualification.Update(this.TransactionManager, h_ProfessionalQualification);
			}
