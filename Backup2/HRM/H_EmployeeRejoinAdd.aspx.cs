    ...
    public partial class H_EmployeeRejoinAdd : AddPage
    {
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                if (h_Employee != null)
                {
                    ...
                    //    }
                    //}
                    Asa.Hrms.Data.Entity.H_EmployeeRejoinHistory h_EmployeeRejoin = this.GetH_EmployeeRejoin();
                   ...
                   // h_Employee.EmploymentType = (H_Employee.EmploymentTypes)DBUtility.ToInt32(ddlRejoinType.SelectedValue);
                    ...
                    if (this.Type == TYPE_EDIT)
                    {
                        Asa.Hrms.Data.Entity.H_EmployeeRejoinHistory.Update(this.TransactionManager, h_EmployeeRejoin);
                    }
                    else
                    {
        ...
        protected override void LoadData()
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                H_EmployeeRejoinHistory h_History = Asa.Hrms.Data.Entity.H_EmployeeRejoinHistory.GetById(Convert.ToInt32(hdnId.Value));
