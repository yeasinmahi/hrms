...
public partial class H_DesignationAdd : AddPage
{
	...
	private Asa.Hrms.Data.Entity.H_Designation GetH_Designation()
	{
		Asa.Hrms.Data.Entity.H_Designation h_Designation = null;

		if (this.Type == TYPE_EDIT)
		{
			h_Designation = Asa.Hrms.Data.Entity.H_Designation.GetById(Convert.ToInt32(hdnId.Value));
		}
		else
		{
			h_Designation = new Asa.Hrms.Data.Entity.H_Designation();
		}
	...
	protected override Message Save()
	{
		...
		{
			Asa.Hrms.Data.Entity.H_Designation h_Designation = this.GetH_Designation();
			string desc = "";
			...
			if (this.Type == TYPE_ADD)
			{
				Asa.Hrms.Data.Entity.H_Designation.Insert(this.TransactionManager, h_Designation);
			...
			{
				Asa.Hrms.Data.Entity.H_Designation.Update(this.TransactionManager, h_Designation);
			}
