<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="DbTransactionDetailsAdd.aspx.cs" Inherits="DbTransactionDetailsAdd" Title="" %>
