<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="GroupSubjectList.aspx.cs" Inherits="GITS.Hrms.WebSite.Admin.GroupSubjectList" Title="" %>
			...
			<td>
				<asp:GridView ID="gvList" runat="server" OnRowCreated="gvList_RowCreated" OnSorting="gvList_Sorting" DataKeyNames="Id">
					<Columns>
						...
						<asp:HyperLinkField HeaderText="Name" DataTextField="Name" SortExpression="Name" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="GroupSubjectAdd.aspx?Id={0}"></asp:HyperLinkField>
					</Columns>
				</asp:GridView>
			</td>
		</tr>
