<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="CountryAdd.aspx.cs" Inherits="GITS.Hrms.WebSite.Admin.CountryAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="3" cellspacing="1">
        ...
        <tr>
            <td colspan="2">
                <asp:HyperLink ID="hlBack" NavigateUrl="~/Admin/CountryList.aspx" runat="server">Back</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
