<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H_EmployeeLeaveList.aspx.cs" Inherits="GITS.Hrms.WebSite.HRM.H_EmployeeLeaveList" MasterPageFile="~/Site.master" Title="" %>
...
<asp:HyperLinkField HeaderText="Employee" DataTextField="Name" SortExpression="Name" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="H_EmployeeLeaveAdd.aspx?Id={0}" />
<mms:BoundField DataField="Code" HeaderText="Emp.ID" FieldType="String" SortExpression="Code"></mms:BoundField>
<mms:BoundField DataField="Type" HeaderText="Leave Type" SortExpression="Type"></mms:BoundField>
...
<mms:BoundField DataField="Cause" HeaderText="Cause of Leave" FieldType="String" SortExpression="Cause"></mms:BoundField>
</Columns>
</asp:GridView>
</td>
</tr>
