<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H_EmployeePenaltyAdd.aspx.cs"
    Inherits="GITS.Hrms.WebSite.HRM.H_EmployeePenaltyAdd" MasterPageFile="~/Site.master"
    Title="" %>
        ...
        <div>
            <div style="float: left; width: auto;">
                <table border="0" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            <strong>Penalty/Fine Information</strong>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFineAmount" runat="server" Width="135px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvFineAmount" runat="server" Display="Dynamic" ControlToValidate="txtFineAmount"
                                ErrorMessage="*" ToolTip="Required"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ControlToValidate="txtFineAmount" ID="rvFineAmount" Type="Double"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlSubzone" runat="server" DataTextField="Name" DataValueField="Id"
                                AutoPostBack="true" OnSelectedIndexChanged="ddlSubzone_SelectedIndexChanged"
                                Width="135px">
                            </asp:DropDownList>
                        </td>
                        <td>
                        ...
                        <asp:TemplateField HeaderText="Action" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%# Eval("Id") %>'
                                    CausesValidation="false" CommandName="deleterow" Text="Delete"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
