    ...
    public partial class H_EmployeeMultiLetterAdd : AddPage
    {
        ...
        protected override void LoadData()
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                letter = H_EmployeeMultiLetter.GetById(Convert.ToInt32(Request.QueryString["Id"]));
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                if (selectedValues.Contains("6"))
                {
                    ...
                    {
                        IList<H_EmployeeConsultency> list = H_EmployeeConsultency.Find("H_EmployeeId=" + h_Employee.Id + " AND Status=1", "");
                        if (list.Count > 0)
                        {
                    ...
                    {
                        IList<H_EmployeeLeave> list = H_EmployeeLeave.Find("H_EmployeeId=" + h_Employee.Id + " AND Status=1", "");
                        if (list.Count > 0)
                        {
