<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="H_SpecialIncrementAdd.aspx.cs" Inherits="GITS.Hrms.WebSite.HRM.H_SpecialIncrementAdd" %>
        ...
        <div>
            <div style="float: left; width: auto;">
                <table border="0" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            <strong>Special Increment</strong>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtEffectiveDate" Text="" MaxLength="10" 
                                Width="135px"></asp:TextBox>
                                <asp:ImageButton ID="ImageButton1" runat="server" SkinID="CalendarImageButton" OnClientClick="javascript:showCalendarControl(document.getElementById('ctl00_ContentPlaceHolder1_txtEffectiveDate'));return false;">
                            </asp:ImageButton>
                            <asp:RequiredFieldValidator ID="rfvEffectiveDate" runat="server" Display="Dynamic" ControlToValidate="txtEffectiveDate"
                                ErrorMessage="*" ToolTip="Required"></asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="cvEffectiveDate" runat="server" ControlToValidate="txtEffectiveDate" Type="Date" Display="Dynamic" Operator="DataTypeCheck" ErrorMessage="*"></asp:CompareValidator>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNumberOfIncrement" runat="server" Width="135px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvFineAmount" runat="server" Display="Dynamic" ControlToValidate="txtNumberOfIncrement"
                                ErrorMessage="*" ToolTip="Required"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ControlToValidate="txtNumberOfIncrement" ID="rvFineAmount" Type="Integer"
                                MaximumValue="2" MinimumValue="1" runat="server" Display="Dynamic"
                                ErrorMessage="*" ToolTip="Invalid Input"></asp:RangeValidator>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
                    ...
                    <tr>
                        <td align="right">
                            Remarks</td>
                        <td colspan="3">
                            <asp:TextBox ID="txtRemarks" runat="server" Width="360px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
            ...
            <div style="width: 500px;">
                <asp:GridView ID="gvList" SkinID="Special" runat="server" OnRowCommand="gvList_RowCommand" >
                    <Columns>
                        ...
                        <mms:BoundField DataField="EffectiveDate" HeaderText="Effective Date" FieldType="DateTime"
                            SortExpression="EffectiveDate" DataFormatString="{0:dd/MM/yyyy}">
                        </mms:BoundField>
                        <mms:BoundField DataField="NumberOfIncrement" HeaderText="Number Of Inc." FieldType="Int32" SortExpression="NumberOfIncrement">
                        </mms:BoundField>
