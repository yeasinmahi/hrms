...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeSalaryAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeSalary GetH_EmployeeSalary()
        {
            Asa.Hrms.Data.Entity.H_EmployeeSalary h_EmployeeSalary = new H_EmployeeSalary();
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                if (h_Employee != null)
                {
                    ...
                    Asa.Hrms.Data.Entity.H_EmployeeSalary h_EmployeeSalary = this.GetH_EmployeeSalary();
                    string desc = "Insert [H_EmployeeSalary]";

                    this.TransactionManager = new TransactionManager(true, desc);

                    Asa.Hrms.Data.Entity.H_EmployeeSalary.Insert(this.TransactionManager, h_EmployeeSalary);
