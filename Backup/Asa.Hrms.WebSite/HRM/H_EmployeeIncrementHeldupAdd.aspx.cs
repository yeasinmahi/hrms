...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeIncrementHeldupAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeIncrementHeldup GetH_EmployeeIncrementHeldup()
        {
            Asa.Hrms.Data.Entity.H_EmployeeIncrementHeldup h_EmployeeIncrementHeldup = new H_EmployeeIncrementHeldup();
        ...
        protected override Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.H_EmployeeIncrementHeldup h_EmployeeIncrementHeldup = this.GetH_EmployeeIncrementHeldup();
                string desc = "Insert [H_EmployeeIncrementHeldup]";

                this.TransactionManager = new TransactionManager(true, desc);

                Asa.Hrms.Data.Entity.H_EmployeeIncrementHeldup.Insert(this.TransactionManager, h_EmployeeIncrementHeldup);
