...
public partial class WF_WelfareFundAssistanceAdd : AddPage
{
    ...
    private Asa.Hrms.Data.Entity.WF_WelfareFundAssistance GetWF_WelfareFundAssistance()
    {
    ...
    protected override Message Save()
    {
        ...
        {
            string desc = null;
            Asa.Hrms.Data.Entity.WF_WelfareFundAssistance h_EmployeeTransfer = this.GetWF_WelfareFundAssistance();
            if (this.Type == TYPE_EDIT)
            {
            ...
            if (this.Type == TYPE_EDIT)
            {
                Asa.Hrms.Data.Entity.WF_WelfareFundAssistance.Update(this.TransactionManager, h_EmployeeTransfer);
            }
            else
            {
                Asa.Hrms.Data.Entity.WF_WelfareFundAssistance.Insert(this.TransactionManager, h_EmployeeTransfer);
            }
