...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeePermanentAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeePermanentHistory GetH_EmployeePermanent()
        {
            Asa.Hrms.Data.Entity.H_EmployeePermanentHistory h_EmployeePenalty = new H_EmployeePermanentHistory();
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                if (this.Type == TYPE_EDIT)
                {
                    Asa.Hrms.Data.Entity.H_EmployeePermanentHistory.Update(this.TransactionManager, h_Permanent);
                }
                else
                {
                    Asa.Hrms.Data.Entity.H_EmployeePermanentHistory.Insert(this.TransactionManager, h_Permanent);
                }
        ...
        protected override void LoadData()
        {
            if (Request.QueryString["Id"] != null)
            {
                ...
                H_EmployeePermanentHistory h_History = Asa.Hrms.Data.Entity.H_EmployeePermanentHistory.GetById(Convert.ToInt32(hdnPer.Value));
