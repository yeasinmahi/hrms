...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeWarningRemissionAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeWarning GetH_EmployeePenalty()
        {
            Asa.Hrms.Data.Entity.H_EmployeeWarning h_Employeewarning = null;
        ...
        protected override Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.H_EmployeeWarning h_EmployeeWarning = this.GetH_EmployeePenalty();
