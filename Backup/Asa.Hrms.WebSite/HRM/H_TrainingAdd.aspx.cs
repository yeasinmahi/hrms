...
public partial class H_TrainingAdd : AddPage
{
	...
	private Asa.Hrms.Data.Entity.H_Training GetH_Training()
	{
		Asa.Hrms.Data.Entity.H_Training h_Training = null;

		if (this.Type == TYPE_EDIT)
		{
			h_Training = Asa.Hrms.Data.Entity.H_Training.GetById(Convert.ToInt32(hdnId.Value));
		}
		else
		{
			h_Training = new Asa.Hrms.Data.Entity.H_Training();
	...
	protected override Message Save()
	{
		...
		{
			Asa.Hrms.Data.Entity.H_Training h_Training = this.GetH_Training();
			string desc = "";
			...
			if (this.Type == TYPE_ADD)
			{
				Asa.Hrms.Data.Entity.H_Training.Insert(this.TransactionManager, h_Training);
			...
			{
				Asa.Hrms.Data.Entity.H_Training.Update(this.TransactionManager, h_Training);
			}
