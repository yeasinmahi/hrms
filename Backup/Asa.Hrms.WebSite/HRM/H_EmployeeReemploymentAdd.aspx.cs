    ...
    public partial class H_EmployeeReemploymentAdd : AddPage
    {
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                if (h_Employee != null)
                {
                    Asa.Hrms.Data.Entity.H_EmployeeReemployment h_EmployeeReemployment = this.GetH_EmployeeReemployment();
                    ...
                    Asa.Hrms.Data.Entity.H_EmployeeReemployment.Insert(this.TransactionManager, h_EmployeeReemployment);
