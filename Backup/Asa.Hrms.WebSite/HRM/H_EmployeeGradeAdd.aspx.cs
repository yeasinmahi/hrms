...
public partial class H_EmployeeGradeAdd : AddPage
{
	...
	private Asa.Hrms.Data.Entity.H_EmployeeGrade GetH_EmployeeGrade()
	{
		Asa.Hrms.Data.Entity.H_EmployeeGrade h_EmployeeGrade = null;

		if (this.Type == TYPE_EDIT)
		{
			h_EmployeeGrade = Asa.Hrms.Data.Entity.H_EmployeeGrade.GetById(Convert.ToInt32(hdnId.Value));
		}
		else
		{
			h_EmployeeGrade = new Asa.Hrms.Data.Entity.H_EmployeeGrade();
		}
	...
	protected override Message Save()
	{
		...
		{
			Asa.Hrms.Data.Entity.H_EmployeeGrade h_EmployeeGrade = this.GetH_EmployeeGrade();
			string desc = "";
			...
			if (this.Type == TYPE_ADD)
			{
				Asa.Hrms.Data.Entity.H_EmployeeGrade.Insert(this.TransactionManager, h_EmployeeGrade);
			...
			{
				Asa.Hrms.Data.Entity.H_EmployeeGrade.Update(this.TransactionManager, h_EmployeeGrade);
			}
	...
	protected override void LoadData()
	{
		...
		this.ddlH_EmployeeId.DataSource = Asa.Hrms.Data.Entity.H_Employee.FindAll();
		this.ddlH_EmployeeId.DataBind();

		this.ddlH_GradeId.DataSource = Asa.Hrms.Data.Entity.H_Grade.FindAll();
