...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeWarningAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeWarning GetH_EmployeeWarning()
        {
            Asa.Hrms.Data.Entity.H_EmployeeWarning h_EmployeeWarning = new H_EmployeeWarning();
        ...
        protected override Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.H_EmployeeWarning h_EmployeeWarning = this.GetH_EmployeeWarning();
                ...
                if (this.Type == TYPE_EDIT)
                {
                    Asa.Hrms.Data.Entity.H_EmployeeWarning.Update(this.TransactionManager, h_EmployeeWarning);
                }
                else
                {
                    Asa.Hrms.Data.Entity.H_EmployeeWarning.Insert(this.TransactionManager, h_EmployeeWarning);
                }
