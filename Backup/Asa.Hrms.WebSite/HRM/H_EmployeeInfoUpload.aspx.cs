...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeInfoUpload : AddPage
    {
        ...
        protected override Asa.Hrms.Utility.Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.H_FileUpload h_FileUpload = this.GetH_FileUpload();
                string desc = "";
                ...
                if (this.Type == TYPE_ADD)
                {
                    Asa.Hrms.Data.Entity.H_FileUpload.Insert(this.TransactionManager, h_FileUpload);
                ...
                {
                    Asa.Hrms.Data.Entity.H_FileUpload.Update(this.TransactionManager, h_FileUpload);
                    if (FileUpload1.HasFile)
                    {
        ...
        {
            Asa.Hrms.Data.Entity.H_FileUpload h_FileUpload = null;

            if (this.Type == TYPE_EDIT)
            {
                h_FileUpload = Asa.Hrms.Data.Entity.H_FileUpload.GetById(Convert.ToInt32(hdnUploadId.Value));
            }
            else
            {
                h_FileUpload = new Asa.Hrms.Data.Entity.H_FileUpload();
