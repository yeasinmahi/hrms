...
namespace Asa.Hrms.WebSite.HRM
{
    public partial class H_EmployeeLeaveAdd : AddPage
    {
        ...
        private Asa.Hrms.Data.Entity.H_EmployeeLeaveHistory GetH_EmployeeLeave()
        {
            Asa.Hrms.Data.Entity.H_EmployeeLeaveHistory h_EmployeeLeave = null;
        ...
        protected override Message Save()
        {
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                if (h_Employee != null)
                {
                    ...
                    Asa.Hrms.Data.Entity.H_EmployeeLeaveHistory h_EmployeeLeave = this.GetH_EmployeeLeave();                  
                    ...
                    if (pastLeave != null && chkCancel.Checked==false)
                    {
                        ...
                        Asa.Hrms.Data.Entity.H_EmployeeLeave.Update(this.TransactionManager, pastLeave);
                    ...
                    if (this.Type == TYPE_EDIT)
                    {
                        ...
                        Asa.Hrms.Data.Entity.H_EmployeeLeaveHistory.Update(this.TransactionManager, h_EmployeeLeave);
                    }
                    else
                    {
                        Asa.Hrms.Data.Entity.H_EmployeeLeaveHistory.Insert(this.TransactionManager, h_EmployeeLeave);
                    }
        ...
        protected override void LoadData()
        {
           ...
           // UIUtility.LoadEnums(ddlJoinType, typeof(H_EmployeeLeave.JoinTypes), false, false, true);
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                H_EmployeeLeaveHistory h_History = Asa.Hrms.Data.Entity.H_EmployeeLeaveHistory.GetById(Convert.ToInt32(hdnId.Value));
