...
namespace Asa.Hrms.WebSite.DbManagement
{
    public partial class DbInstall : System.Web.UI.Page
    {
        ...
        protected void btnBackup_Click(object sender, EventArgs e)
        {
            ...
            String file = Path.GetTempPath() + DateTime.Now.ToString("yyyyMMddHHmmss_") + Asa.Hrms.Utility.Configuration.DatabaseName + "_" + Asa.Hrms.Utility.Configuration.Version;
            ...
            if (msg.Type == MessageType.Information)
            {
                ...
                Utility.UIUtility.Transfer(Page, "../Export.aspx?path=" + file.Replace("\\", "\\\\"));
        ...
        {
            Message msg = this.databaseManagementManager.ShrinkDatabase(Asa.Hrms.Utility.Configuration.DatabaseName);
