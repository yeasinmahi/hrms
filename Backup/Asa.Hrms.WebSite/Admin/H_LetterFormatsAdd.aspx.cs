...
namespace Asa.Hrms.WebSite.Admin
{
    public partial class H_LetterFormatsAdd : AddPage
    {
        ...
        protected override void LoadData()
        {
            ...
            Asa.Hrms.Data.Entity.H_LetterFormats config = null;

            if (Request.QueryString["Id"] != null)
            {
                hdnId.Value = Request.QueryString["Id"];
                config = Asa.Hrms.Data.Entity.H_LetterFormats.GetById(Convert.ToInt32(hdnId.Value));
        ...
        private Asa.Hrms.Data.Entity.H_LetterFormats GetLetterFormats()
        {
            Asa.Hrms.Data.Entity.H_LetterFormats letterFormats = null;

            if (this.Type == TYPE_EDIT)
            {
                letterFormats = Asa.Hrms.Data.Entity.H_LetterFormats.GetById(Convert.ToInt32(hdnId.Value));
            }
            else
            {
                letterFormats = new Asa.Hrms.Data.Entity.H_LetterFormats();
            }
        ...
        protected override Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.H_LetterFormats h_LetterFormats = this.GetLetterFormats();
                string desc = "";
                ...
                if (this.Type == TYPE_ADD)
                {
                    Asa.Hrms.Data.Entity.H_LetterFormats.Insert(this.TransactionManager, h_LetterFormats);
                ...
                {
                    Asa.Hrms.Data.Entity.H_LetterFormats.Update(this.TransactionManager, h_LetterFormats);
                }
