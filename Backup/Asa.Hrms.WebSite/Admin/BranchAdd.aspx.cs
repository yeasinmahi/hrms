...
public partial class BranchAdd : AddPage
{
	...
	private Asa.Hrms.Data.Entity.Branch GetBranch()
	{
		Asa.Hrms.Data.Entity.Branch branch = null;

		if (this.Type == TYPE_EDIT)
		{
			branch = Asa.Hrms.Data.Entity.Branch.GetById(Convert.ToInt32(hdnId.Value));
		}
		else
		{
			branch = new Asa.Hrms.Data.Entity.Branch();
		}
	...
	protected override Message Save()
	{
		...
		{
			Asa.Hrms.Data.Entity.Branch branch = this.GetBranch();
			string desc = "";
			...
			if (this.Type == TYPE_ADD)
			{
				Asa.Hrms.Data.Entity.Branch.Insert(this.TransactionManager, branch);
			...
			else
			{
				...
				Asa.Hrms.Data.Entity.Branch.Update(this.TransactionManager, branch);
	...
	protected override void LoadData()
	{
        ...
        this.ddlDistrictId.DataSource = Asa.Hrms.Data.Entity.District.Find("","Name");
		...
		if (Request.QueryString["Id"] != null)
		{
			...
			if (branch != null)
			{
                ...
                Asa.Hrms.Data.Entity.Thana thana = Thana.GetById(Convert.ToInt32(branch.ThanaId));
                Asa.Hrms.Data.Entity.Region region = Region.GetById(Convert.ToInt32(branch.RegionId));
    ...
    protected void ddlDistrictId_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            this.ddlThanaId.DataSource = Asa.Hrms.Data.Entity.Thana.FindByDistrictId(Convert.ToInt32(this.ddlDistrictId.SelectedValue), "");
    ...
    protected void ddlZoneId_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            this.ddlSubzoneId.DataSource = Asa.Hrms.Data.Entity.Subzone.Find("ZoneId="+Convert.ToInt32(this.ddlZoneId.SelectedValue)+" AND Status=1", "");
    ...
    protected void ddlSubzoneId_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            this.ddlRegionId.DataSource = Asa.Hrms.Data.Entity.Region.Find("SubzoneId="+Convert.ToInt32(this.ddlSubzoneId.SelectedValue)+" AND Status=1", "");
