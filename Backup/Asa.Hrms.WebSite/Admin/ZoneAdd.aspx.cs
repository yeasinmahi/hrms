...
public partial class ZoneAdd : AddPage
{
	...
	private Asa.Hrms.Data.Entity.Zone GetZone()
	{
        Asa.Hrms.Data.Entity.Zone division = null;

		if (this.Type == TYPE_EDIT)
		{
            division = Asa.Hrms.Data.Entity.Zone.GetById(Convert.ToInt32(hdnId.Value));
		}
		else
		{
            division = new Asa.Hrms.Data.Entity.Zone();
		}
	...
	protected override Message Save()
	{
		...
		{
			Asa.Hrms.Data.Entity.Zone division = this.GetZone();
			string desc = "";
			...
			if (this.Type == TYPE_ADD)
			{
				Asa.Hrms.Data.Entity.Zone.Insert(this.TransactionManager, division);
			...
			{
				Asa.Hrms.Data.Entity.Zone.Update(this.TransactionManager, division);
			}
