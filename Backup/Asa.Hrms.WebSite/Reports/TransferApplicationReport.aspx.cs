...
namespace Asa.Hrms.WebSite.Reports
{
    public partial class TransferApplicationReport : GridPage
    {
        ...
        {
            UIUtility.LoadEnums(ddlStatus, typeof(Asa.Hrms.Data.Entity.H_EmployeeTransferApplication.Statuses), false,false, false);
        }
        ...
        private void ViewReport()
        {
            ...
            ExcelReportUtility.Instance.Name = "Emp_Info_" + "(" + DateTime.Now.Ticks + ")" + Asa.Hrms.Utility.Configuration.ReportExtension;
