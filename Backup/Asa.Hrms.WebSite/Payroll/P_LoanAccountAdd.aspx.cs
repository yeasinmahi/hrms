...
namespace Asa.Hrms.WebSite.Payroll
{
    public partial class P_LoanAccountAdd : AddPage
    {
        ...
        protected override void LoadData()
        {
            ...
            this.ddlLoan.DataSource = P_Loan.Find("Status=1", "Name");
            this.ddlLoan.DataBind();
            this.ddlLoan.Items.Insert(0, new ListItem("Select Loan Type","0"));
        ...
        protected override Message Save()
        {
            ...
            {
                string desc = null;
                Asa.Hrms.Data.Entity.P_LoanAccount p_LoanAccount = this.GetP_LoanAccount();
                if (this.Type == TYPE_EDIT)
                {
                ...
                if (this.Type == TYPE_EDIT)
                {
                    Asa.Hrms.Data.Entity.P_LoanAccount.Update(this.TransactionManager, p_LoanAccount);
                }
                else
                {
                    Asa.Hrms.Data.Entity.P_LoanAccount.Insert(this.TransactionManager, p_LoanAccount);
                }
