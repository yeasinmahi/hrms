    ...
    public partial class P_PayScaleAdd : AddPage
    {
        ...
        protected override void LoadData()
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                P_PayScale p_Loan = Asa.Hrms.Data.Entity.P_PayScale.GetById(Convert.ToInt32(hdnId.Value));
        ...
        protected override Asa.Hrms.Utility.Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.P_PayScale p_Loan = this.Get_PayScale();
                string desc = "";
                ...
                if (this.Type == TYPE_ADD)
                {
                    Asa.Hrms.Data.Entity.P_PayScale.Insert(this.TransactionManager, p_Loan);
                ...
                {
                    Asa.Hrms.Data.Entity.P_PayScale.Update(this.TransactionManager, p_Loan);
                }
