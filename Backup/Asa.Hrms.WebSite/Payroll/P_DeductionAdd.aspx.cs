    ...
    public partial class P_DeductionAdd : AddPage
    {
        ...
        protected override void LoadData()
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                P_Deduction h_Designation = Asa.Hrms.Data.Entity.P_Deduction.GetById(Convert.ToInt32(hdnId.Value));
        ...
        private Asa.Hrms.Data.Entity.P_Deduction GetP_Earning()
        {
            Asa.Hrms.Data.Entity.P_Deduction h_Designation = null;

            if (this.Type == TYPE_EDIT)
            {
                h_Designation = Asa.Hrms.Data.Entity.P_Deduction.GetById(Convert.ToInt32(hdnId.Value));
            }
            else
            {
                h_Designation = new Asa.Hrms.Data.Entity.P_Deduction();
            }
        ...
        protected override Message Save()
        {
            ...
            {
                Asa.Hrms.Data.Entity.P_Deduction h_Designation = this.GetP_Earning();
                string desc = "";
                ...
                if (this.Type == TYPE_ADD)
                {
                    Asa.Hrms.Data.Entity.P_Deduction.Insert(this.TransactionManager, h_Designation);
                ...
                {
                    Asa.Hrms.Data.Entity.P_Deduction.Update(this.TransactionManager, h_Designation);
                }
