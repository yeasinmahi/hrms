...
public partial class P_LateAttendanceAdd : AddPage
{
    ...
    private Asa.Hrms.Data.Entity.P_LateAttendance GetAttendance()
    {
        Asa.Hrms.Data.Entity.P_LateAttendance attendance = null;

        if (this.Type == TYPE_EDIT)
        {
            attendance = Asa.Hrms.Data.Entity.P_LateAttendance.GetById(Convert.ToInt32(hdnId.Value));
        }
        else
        {
            attendance = new Asa.Hrms.Data.Entity.P_LateAttendance();
    ...
    protected override Message Save()
    {
        ...
        {
            Asa.Hrms.Data.Entity.P_LateAttendance division = this.GetAttendance();
            string desc = "";
            ...
            if (this.Type == TYPE_ADD)
            {
                Asa.Hrms.Data.Entity.P_LateAttendance.Insert(this.TransactionManager, division);
            ...
            {
                Asa.Hrms.Data.Entity.P_LateAttendance.Update(this.TransactionManager, division);
            }
    ...
    protected override void LoadData()
    {
        ...
        Asa.Hrms.Data.Entity.P_LateAttendance division = null;

        if (Request.QueryString["Id"] != null)
        {
            hdnId.Value = Request.QueryString["Id"];
            division = Asa.Hrms.Data.Entity.P_LateAttendance.GetById(Convert.ToInt32(hdnId.Value));
