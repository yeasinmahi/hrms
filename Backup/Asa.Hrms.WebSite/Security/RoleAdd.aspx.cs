...
public partial class RoleAdd : Asa.Hrms.Web.AddPage
{
	...
	private Asa.Hrms.Data.Entity.Role GetRole()
	{
		Asa.Hrms.Data.Entity.Role role = null;

		if (this.Type == TYPE_EDIT)
		{
			role = Asa.Hrms.Data.Entity.Role.GetById(Convert.ToInt32(hdnId.Value));
		}
		else
		{
			role = new Asa.Hrms.Data.Entity.Role();
		}
	...
	protected override Message Save()
	{
		...
		{
            Asa.Hrms.Data.Entity.Role role = this.GetRole();
            string desc = "";
			...
			if (this.Type == TYPE_ADD)
			{
                Asa.Hrms.Data.Entity.Role.Insert(this.TransactionManager, role);
                ...
                foreach (GridViewRow gvr in gvList.Rows)
                {
                    if (((CheckBox)gvr.FindControl("chkProperty")).Checked)
                    {
                        ...
                        Asa.Hrms.Data.Entity.RoleProperty.Insert(this.TransactionManager, rp);
                    }
			...
			{
                //update role
                Asa.Hrms.Data.Entity.Role.Update(this.TransactionManager, role);
    ...
    protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.DataItem != null)
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                role = Asa.Hrms.Data.Entity.Role.GetById(Convert.ToInt32(Request.QueryString["Id"]));
            }
