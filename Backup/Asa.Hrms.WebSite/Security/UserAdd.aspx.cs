...
public partial class UserAdd : Asa.Hrms.Web.AddPage
{
    ...
    private Asa.Hrms.Data.Entity.User GetUser()
    {
        Asa.Hrms.Data.Entity.User user = null;

        if (this.Type == TYPE_EDIT)
        {
            user = Asa.Hrms.Data.Entity.User.GetById(Convert.ToInt32(hdnId.Value));
        }
        else
        {
            user = new Asa.Hrms.Data.Entity.User();
        ...
        user.IsReset = false;
        user.UserType = (Asa.Hrms.Data.Entity.User.UserTypes)DBUtility.ToInt32(ddlUserType.SelectedValue);
    ...
    protected override Message Save()
    {
        ...
        {
            Asa.Hrms.Data.Entity.User user = this.GetUser();
            string desc = "";
            ...
            if (this.Type == TYPE_ADD)
            {
                Asa.Hrms.Data.Entity.User.Insert(this.TransactionManager, user);
