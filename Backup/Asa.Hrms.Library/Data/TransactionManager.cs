...
namespace Asa.Hrms.Data
{
    ...
    public class TransactionManager
    {
        ...
        public TransactionManager(Boolean beginTransaction, String description, String database)
        {
            ...
            String cs = Asa.Hrms.Utility.Configuration.ConnectionString;

            if (database == null)
            {
                cs = cs.Replace("Initial Catalog=" + Asa.Hrms.Utility.Configuration.DatabaseName + ";", "");
            }
            else if (database != "")
            {
                cs = cs.Replace("Initial Catalog=" + Asa.Hrms.Utility.Configuration.DatabaseName + ";", "Initial Catalog=" + database + ";");
            }
        ...
        public Asa.Hrms.Utility.Message SetDataSet(DataSet ds, string dbName)
        {
            Asa.Hrms.Utility.Message msg = new Message();
