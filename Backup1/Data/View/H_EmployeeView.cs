...
namespace Asa.Hrms.Data.View
{
	...
	public class H_EmployeeView : ViewBase<H_EmployeeView>
	{
		...
		protected override H_EmployeeView Map(SqlDataReader dataReader)
		{
			...
			view.Sex = DBUtility.ToString(dataReader["Sex"]);
            view.MaritalStatus = DBUtility.ToString(dataReader["MaritalStatus"]);
            view.Religion = DBUtility.ToString(dataReader["Religion"]);
            ...
            view.EmploymentType = DBUtility.ToString(dataReader["EmploymentType"]);
